										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>客户名称：</TD>
													<TD>
													<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" value="${model.cust_name }" maxLength=50 name="cust_name">
													</TD>
													<TD>客户级别：</TD>
													<TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer_delete.action?cust_id=${customer.cust_id}" onclick="return window.confirm('您真的残忍删除我吗?')">删除</a>
													</TD>
												</TR>
