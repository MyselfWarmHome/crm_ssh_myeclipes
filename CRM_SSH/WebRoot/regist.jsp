...
<script type="text/javascript">
	...
	$(function(){
		$("#user_code").blur(function(){
			...
			//登录名不为空,发送ajax请求
			$.post("${pageContext.request.contextPath }/user_checkCode.action",{"user_code":$code},function(data){
					//操作data,进行判断
					if(data &&  data == "no"){
						$("#codeId").html("登录名已经存在");
					}else{
						$("#codeId").removeClass("error");
						$("#codeId").html("<font color='green'>可以注册</font>");
					}
				});
			}
		});
